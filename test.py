...
form_8_1.send_keys(mojimoji.zen_to_han(jygs.num[0]))
form_8_2.send_keys(mojimoji.zen_to_han(jygs.num[1]))
form_8_3.send_keys(mojimoji.zen_to_han(jygs.num[2]))
...
form_10_1.send_keys(mojimoji.zen_to_han(kysh.tin[0]))
form_10_2.send_keys(mojimoji.zen_to_han(kysh.tin[1]))
